...
export default async function handler(req, res) {
  ...
  try {
    await resend.emails.send({
      ...
      html: `
        <div style="font-family:'Syne',Arial,sans-serif;background:#0a0a0b;padding:40px 20px">
          <div style="max-width:420px;margin:0 auto;background:#111114;border:1px solid rgba(255,255,255,.12);border-radius:14px;padding:40px">
            <div style="width:36px;height:36px;background:#2dcc8f;border-radius:8px;font-family:monospace;font-size:13px;font-weight:500;color:#0a0a0b;display:flex;align-items:center;justify-content:center;margin-bottom:28px">bf</div>
